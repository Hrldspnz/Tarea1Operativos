...
module platform_mm_interconnect_1 (
		...
		input  wire [11:0] cpu_instruction_master_address,        //          cpu_instruction_master.address
	...
	wire  [11:0] cpu_instruction_master_translator_avalon_universal_master_0_address;       // cpu_instruction_master_translator:uav_address -> cpu_instruction_master_agent:av_address
	...
	wire  [83:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_instruction_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                         // cpu_instruction_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [0:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> cpu_instruction_master_agent:rp_channel
	...
	wire  [11:0] rom_s1_agent_m0_address;                                                   // ROM_s1_agent:m0_address -> ROM_s1_translator:uav_address
	...
	wire  [84:0] rom_s1_agent_rf_source_data;                                               // ROM_s1_agent:rf_source_data -> ROM_s1_agent_rsp_fifo:in_data
	...
	wire  [84:0] rom_s1_agent_rsp_fifo_out_data;                                            // ROM_s1_agent_rsp_fifo:out_data -> ROM_s1_agent:rf_sink_data
	...
	wire  [83:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> ROM_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                         // ROM_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [0:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> ROM_s1_agent:cp_channel
	...
	wire  [83:0] cpu_instruction_master_agent_cp_data;                                      // cpu_instruction_master_agent:cp_data -> router:sink_data
	...
	wire  [83:0] rom_s1_agent_rp_data;                                                      // ROM_s1_agent:rp_data -> router_001:sink_data
